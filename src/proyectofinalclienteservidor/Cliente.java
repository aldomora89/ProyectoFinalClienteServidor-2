...
public class Cliente extends Persona {
    ...
    public Cliente(String name, int age, int nivelDeUsuario, int id, int mesesEnElGym, Tarifas tarifa) { //Al inscribir un usuario, necesitamos nombre, edad, privilegio (por defecto)
